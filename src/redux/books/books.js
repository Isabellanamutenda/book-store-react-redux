...
export const fetchData = () => async (dispatch) => {
  const response = await fetch(
    'https://us-central1-bookstore-api-e63c8.cloudfunctions.net/bookstoreApi/apps/8uyccLaygYAG9c3K3wyv/books',
  );
...
export const removeBook = (book) => async (dispatch) => {
  fetch(
    `https://us-central1-bookstore-api-e63c8.cloudfunctions.net/bookstoreApi/apps/8uyccLaygYAG9c3K3wyv/books/${book.item_id}`,
    {
      method: 'DELETE',
    },
  );
